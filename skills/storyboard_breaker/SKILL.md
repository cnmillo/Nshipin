...
- 若存在旁白，统一写入 `dialogue`，格式为 `旁白：【情感】内容`
- 多角色对话必须按角色分行，每行格式为 `角色名：【情感】台词内容`，例如：
  ```
  妈妈：【温柔】今天怎么啦，晓晨？
  晓晨：【委屈】没什么，妈妈。
  ```
  **每句对白必须标注情感词**（如愤怒、悲伤、开心、温柔、恐惧、惊讶、坚定、冷漠等），用【】包裹
  **禁止**将多个角色的台词写在同一行，如 `妈妈：【温柔】今天怎么啦？晓晨：【委屈】没什么。` 是错误格式
