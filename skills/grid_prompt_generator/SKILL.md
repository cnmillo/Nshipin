...
所有提示词必须根据 `drama.style` 注入对应的视觉风格关键词。系统已内置以下风格映射：

| 风格 | 值 | 角色关键词 | 场景关键词 |
|------|------|-----------|-----------|
| 写实 | `realistic` | photorealistic, hyperrealistic, 8k uhd, natural skin texture | photorealistic, hyperrealistic, 8k uhd, natural lighting |
| 动漫 | `anime` | anime style, cel-shaded, vibrant colors, clean lineart | anime style, cel-shaded, vibrant colors |
| 吉卜力 | `ghibli` | Studio Ghibli style, soft watercolor, whimsical, Miyazaki-inspired | Studio Ghibli style, soft watercolor, whimsical, hand-painted |
| 电影感 | `cinematic` | cinematic, dramatic lighting, film grain, anamorphic lens | cinematic, dramatic lighting, film grain, anamorphic lens |
| 漫画 | `comic` | comic book style, bold outlines, halftone dots, dynamic shading | comic book style, bold outlines, halftone dots |
| 水彩 | `watercolor` | watercolor painting, soft edges, flowing colors, artistic | watercolor painting, soft edges, flowing colors, artistic |

**规则**：风格关键词由系统自动注入，Agent 只需确保提示词结构正确即可。
