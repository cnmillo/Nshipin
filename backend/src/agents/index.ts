...
- action：角色动作与表演
- dialogue：该镜头实际发生的对白或旁白；旁白可写为"旁白：【情感】内容"；多角色对话必须按角色分行，每行格式为"角色名：【情感】台词"，禁止将多角色台词写在同一行。每句对白必须标注情感词（如愤怒、悲伤、开心、温柔、恐惧、惊讶、坚定、冷漠等），用【】包裹
